package ceruleanotter.github.com.sunshine.service;
...
import ceruleanotter.github.com.sunshine.Utility;
...
public class SunshineService extends IntentService {
    ...
    public static final String LOCATION_QUERY = "locationQueryForHandleIntent";
    ...
    protected void onHandleIntent(Intent intent) {
        mContext = this;
        Log.d(LOG_TAG, "On Handle Intent Started");
        //if there's no zipcode, there's nothing to lookup
        if (!intent.hasExtra(LOCATION_QUERY)) return;
...
;
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(mContext.getString(R.string.pref_key_units), mContext.getString(R.string.pref_metric_units));

        if (unitType.equals(mContext.getString(R.string.pref_imperial_units))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_metric_units))) {
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d("alarm", "alarm recieved");
            Intent finalIntent = new Intent(context, SunshineService.class);
            finalIntent.putExtra(SunshineService.LOCATION_QUERY, intent.getStringExtra(SunshineService.LOCATION_QUERY));
